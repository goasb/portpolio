...
//  let myAbout_offset = about_offset - (winH/2);
...
//     if(winScroll > myAbout_offset){
//         aboutMe.addClass('action');
//         aboutCar.addClass('action');
//     }else{
//         aboutMe.removeClass('action');
//         aboutCar.removeClass('action');
//     };
//  });
